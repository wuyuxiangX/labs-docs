...
| voice_id | string | Yes | Voice ID (preset or cloned voice) |
| model | string | No | TTS model: `speech-2.6-hd` (default), `speech-02-hd` |
...
| volume | number | No | Volume 0-10 (default 1.0) |
| pitch | integer | No | Pitch -12 to 12 (default 0) |
...
| tts.voice.not_found | Voice ID does not exist |
