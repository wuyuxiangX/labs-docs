...
|-------|-------------|----------|
| `user.info` | Access user's basic info (name, email, avatar, etc.) | User Info |
| `user.info.shades` | Access user's interest tags | User Info |
| `user.info.softmemory` | Access user's soft memories | User Info |
| `note.add` | Add notes and memories | Notes |
